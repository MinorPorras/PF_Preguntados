Public Class P_PReportesPrincipal
    ...
    Private Sub BTN_VerCategorias_Click(sender As Object, e As EventArgs) Handles BTN_VerRepGen.Click
        P_PReporteGeneralPrincipal.Show()
        Me.Close()
    End Sub

    Private Sub BTN_VerPregunta_Click(sender As Object, e As EventArgs) Handles BTN_VerRepInd.Click
        P_PReporteIndividualPrincipal.Show()
        Me.Close()
    End Sub

    Private Sub P_PReportesPrincipal_Load(sender As Object, e As EventArgs) Handles MyBase.Load

    End Sub

    Private Sub P_PReportesPrincipal_KeyPress(sender As Object, e As KeyPressEventArgs) Handles MyBase.KeyPress
        If e.KeyChar = "1"c Then
            BTN_VerRepGen.PerformClick()
        ElseIf e.KeyChar = "2"c Then
            BTN_VerRepInd.PerformClick()
