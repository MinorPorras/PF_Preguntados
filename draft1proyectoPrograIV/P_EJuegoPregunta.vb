...
Public Class P_EJuegoPregunta
    ...
    '------------------------------------Método load--------------------------------------------------------------------------
    Private Sub P_PEVideo_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        TXT_Tiempo.Text = TiempoRest.ToString()
        PRB_Preg.Maximum = CInt(TiempoRest.TotalSeconds)
        PRB_Preg.Value = PRB_Preg.Maximum
        TimerPreg.Start()
    End Sub
    ...
    'Timer de tiempo restante para responder la pregunta
    Private Sub TimerPreg_Tick(sender As Object, e As EventArgs) Handles TimerPreg.Tick
        If TiempoRest.TotalSeconds > 0 Then
            ...
            TXT_Tiempo.Text = TiempoRest.ToString()
            PRB_Preg.Value = CInt(TiempoRest.TotalSeconds)
        Else
    ...
    Private Sub P_EJuegoPregunta_KeyPress(sender As Object, e As KeyPressEventArgs) Handles MyBase.KeyPress
